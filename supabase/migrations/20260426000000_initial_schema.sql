...
CREATE OR REPLACE VIEW v_fcr_rate AS
SELECT
...
-- CSAT / CES Averages
CREATE OR REPLACE VIEW v_satisfaction_scores AS
SELECT
...
VALUES ('00000000-0000-0000-0000-000000000000', 'sistema@sede.cl', 'Usuario Sistema', 'admin', 'Sistemas')

      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-20 sm:py-32">
        <div className="relative z-10">
          ...
          <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up delay-300">
            ...
            <Link
              href="/perfil"
              className="px-8 py-4 sm:py-5 rounded-2xl bg-white border border-slate-200 text-slate-700 font-bold text-base sm:text-lg hover:bg-slate-50 hover:border-indigo-200 transition-all text-center shadow-sm"
            >
              Ver Mi Perfil
            </Link>
          </div>
